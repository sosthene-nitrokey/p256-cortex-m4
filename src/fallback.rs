...
impl SecretKey {
    ...
    pub fn sign_prehashed(
        ...
        let prehashed_message: [u8; 32] = prehashed_message.try_into().unwrap();
        let mut rng = rng;
        ...
        loop {
            ...
            if let Ok((signature, _)) =
                static_scalar.try_sign_prehashed(blinded_scalar, prehashed_message.into())
            {
...
impl PublicKey {
    ...
    pub fn verify_prehashed(&self, prehashed_message: &[u8], signature: &Signature) -> bool {
        ...
        self.0
            .as_affine()
            .verify_prehashed(prehashed_message.into(), &signature.0)
            .is_ok()
    }
